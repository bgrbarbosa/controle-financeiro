...
@Controller
@RequestMapping(value = "/relatorio/receita")
public class RelatórioReceitasController {
    ...
    public ModelAndView home() {
        ModelAndView mv = new ModelAndView("/relatorio/receita/index");
        return mv;
    }
    ...
    public ModelAndView findByPeriod(
        ...
        ModelAndView mv = new ModelAndView("/relatorio/receita/index");
        mv.addObject("lancamentos", lancamentosReceita);
